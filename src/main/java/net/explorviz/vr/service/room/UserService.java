...
public class UserService {
	...
	public UserService(Room room, IdGenerationService idGenerationService,
			ColorAssignmentService colorAssignmentService, Event<UserConnectedEvent> userConnectedEvent,
			Event<UserDisconnectedEvent> userDisconnectedEvent, GrabService grabService) {
		this.room = room;
